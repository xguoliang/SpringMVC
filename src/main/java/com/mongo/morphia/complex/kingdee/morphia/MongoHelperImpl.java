...
import com.mongo.morphia.complex.kingdee.core.dao.factory.DataSourceHelper;
import com.mongo.morphia.complex.kingdee.core.server.AbstractDynaBean;
...
public class MongoHelperImpl implements com.mongo.morphia.complex.kingdee.morphia.integer.MongoHelper {
...
//        Datastore ds = morphia.createDatastore(getMongo(), collectionName);
//        ds.get();
//        ds.find(arg0);
//        UpdateOperations<entityClass> ops = ds.createUpdateOperations(entityClass).set("lastLogin", 1111);
//        ds.update("id", UpdateOperations);
//       Query<entityClass> query =ds.createQuery(entityClass.getClass()).filter("foo >", 12);
//    }
