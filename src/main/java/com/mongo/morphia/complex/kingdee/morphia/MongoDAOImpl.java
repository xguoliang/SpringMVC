...
import com.mongo.morphia.complex.kingdee.ano.Cascade;
import com.mongo.morphia.complex.kingdee.core.Utils;
import com.mongo.morphia.complex.kingdee.core.dao.AbstractDAO;
...
//	
	 ...
	 */
	@Override
    public CriteriaQueryBuilderImpl<E> getCriteriaQueryBuilder() {
...
//
     ...
     */
    @Override
    protected void _save(E bObj) throws DataAccessException {
        innerSave(bObj,null);
    }
//	
//	@Override
